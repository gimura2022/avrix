...
void D_VID_TEXT_hd44780_Init(void) {
    ...
    D_VID_TEXT_hd44780_CursorToHome();
    D_VID_TEXT_hd44780_Set2Line4BitsMode();
    D_VID_TEXT_hd44780_SetDisabledCursor();
    D_VID_TEXT_hd44780_MoveCursorToRight();
    D_VID_TEXT_hd44780_ClearDisplay();
